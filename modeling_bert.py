...
class Augmentation(nn.Module):
    def __init__(self, direction, rate, embedding_instance):
        super(Augmentation, self).__init__()
        self.direction = direction
        self.rate = rate
        self.embedding_instance = embedding_instance

    def forward(self, input_ids, position_ids, token_type_ids, attention_mask, augmentation_type):
        ...
        if not self.training or augmentation_type is None:
            embedding_output = self.embedding_instance(input_ids = input_ids, token_type_ids = token_type_ids, position_ids = position_ids)
...
class BertModel(BertPreTrainedModel):
    ...
    def __init__(self, config, add_pooling_layer=True, **kwargs):
        ...
        self.augmentation = Augmentation(kwargs['direction'], kwargs['cutoff_rate'], self.embeddings)
    ...
    def forward(
        ...
        embedding_output = self.augmentation(
            input_ids=input_ids,
